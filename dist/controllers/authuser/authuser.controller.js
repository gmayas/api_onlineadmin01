...
exports.signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Email Validation
        emailuserExists = yield database_1.default.query('SELECT * FROM authuser.users WHERE emailuser = $1', [newUser.emailuser]);
        ...
        emailuserExists = yield database_1.default.query('SELECT id FROM authuser.users WHERE emailuser = $1', [newUser.emailuser]);
...
exports.profile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield database_1.default.query('SELECT * FROM authuser.users WHERE emailuser = $1 ORDER BY id ASC LIMIT 1', [req.emailUser]);
...
exports.updatePasswordUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log('newUser: ', newUser);
        // update new password
        const response = yield database_1.default.query('UPDATE authuser.users SET passworduser = $1 WHERE emailuser = $2', [newUser.passworduser, newUser.emailuser]);
        return res.status(200).json({
...
exports.getTypeOfUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield database_1.default.query('SELECT * FROM authuser.typeofuser Order by usertype;');
        return res.status(200).json({
            message: 'Query succesfully',
            data: response.rows
        });
